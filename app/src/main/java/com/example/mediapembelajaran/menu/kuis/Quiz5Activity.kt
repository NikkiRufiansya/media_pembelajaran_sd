...
import com.example.mediapembelajaran.databinding.ActivityQuiz5Binding
...
class Quiz5Activity : AppCompatActivity() {
    ...
    private fun checkAllDropsCompleted() {
        val totalDropCount = dropCount1 +
                ...
                dropCount9 +
                dropCount10
        val expectedDropCount = 6 // Jumlah drop yang diharapkan
        var scoreHasil = 0
        ...
        binding.btnNext?.setOnClickListener {
           // Toast.makeText(this, scoreHasil.toString(), Toast.LENGTH_SHORT).show()
            ...
            val intent = Intent(this, Quiz6Activity::class.java)
    ...
    fun dialogBenar(){
        ...
        dialogButton.setOnClickListener {
            alertDialog!!.dismiss()
            startActivity(Intent(this, Quiz6Activity::class.java))
            finish()
        }
    }
