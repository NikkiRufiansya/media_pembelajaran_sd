...
import com.example.mediapembelajaran.databinding.ActivityQuiz6Binding

class Quiz6Activity : AppCompatActivity() {
    lateinit var binding : ActivityQuiz6Binding
    ...
    private fun checkAllDropsCompleted() {
        ...
        binding.btnNext?.setOnClickListener {
           // Toast.makeText(this, scoreHasil.toString(), Toast.LENGTH_SHORT).show()
            ...
            val intent = Intent(this, Quiz7Activity::class.java)
    ...
    fun dialogBenar(){
        ...
        dialogButton.setOnClickListener {
            alertDialog!!.dismiss()
            startActivity(Intent(this, Quiz7Activity::class.java))
            finish()
        }
    }
