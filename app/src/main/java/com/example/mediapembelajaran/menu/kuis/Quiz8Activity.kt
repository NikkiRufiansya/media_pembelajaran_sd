...
import com.example.mediapembelajaran.databinding.ActivityQuiz8Binding

class Quiz8Activity : AppCompatActivity() {
    lateinit var binding: ActivityQuiz8Binding
    var dropCount1 = 0
    var dropCount2 = 0
    var dropCount3 = 0
    var dropCount4 = 0
    ...
    private fun checkAllDropsCompleted() {
        ...
        benar = if (totalDropCount == expectedDropCount && binding.gridAnswerBox?.childCount == expectedDropCount) {
            ...
            dialogButton.setOnClickListener {
                alertDialog!!.dismiss()
                startActivity(Intent(this, Quiz9Activity::class.java))
                finish()
            }
            true
        } else {
