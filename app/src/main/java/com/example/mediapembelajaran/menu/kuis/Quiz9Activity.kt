...
import com.example.mediapembelajaran.databinding.ActivityQuiz9Binding

class Quiz9Activity : AppCompatActivity() {
    lateinit var binding : ActivityQuiz9Binding
    var dropCount1 = 0
    var dropCount2 = 0
    var dropCount3 = 0
    var dropCount4 = 0
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityQuiz9Binding.inflate(layoutInflater)
    ...
    private fun checkAllDropsCompleted() {
        val totalDropCount = dropCount1 +
                ...
                dropCount9 +
                dropCount10
        val expectedDropCount = 4 // Jumlah drop yang diharapkan
        var scoreHasil = 0
        ...
        binding.btnNext?.setOnClickListener {
            ...
            val intent = Intent(this, Quiz10Activity::class.java)
    ...
    fun dialogBenar(){
        ...
        dialogButton.setOnClickListener {
            alertDialog!!.dismiss()
            startActivity(Intent(this, Quiz10Activity::class.java))
            finish()
        }
    }
